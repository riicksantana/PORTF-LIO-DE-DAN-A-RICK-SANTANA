...
const PROJECTS: Project[] = [
  ...
  {
    id: 1,
    title: "Performance Rick Santana @ BaianaSystem",
    category: "SHOWS",
    videoId: "sTOTjHhJSJg",
  ...
  {
    id: 2,
    title: "RICK SANTANA CHOREOGRAPHY // WORKSHOP 2023",
    category: "AULAS",
    videoId: "1ENDS5zWHxU",
  ...
  {
    id: 3,
    title: "RICK SANTANA CHOREOGRAPHY // URBAN CLASS",
    category: "AULAS",
    videoId: "2eFZgn9RfVk",
  ...
  {
    id: 4,
    title: "RICK SANTANA // BODY CONTROL SESSION",
    category: "AULAS",
    videoId: "jGQmw-qoZmc",
  ...
  {
    id: 6,
    title: "RICK SANTANA - CLASS SHORT",
    category: "AULAS",
    videoId: "A_Qa5SNizsk",
  ...
  {
    id: 7,
    title: "ADVANCED CHOREOGRAPHY RICK SANTANA",
    category: "AULAS",
    videoId: "Pj4USkp3kR8",
  ...
  {
    id: 8,
    title: "DANCE FOUNDATIONS // RICK SANTANA",
    category: "AULAS",
    videoId: "5j4Sy8_zZtM",
  ...
  {
    id: 9,
    title: "STUDIO CLASS // RICK SANTANA",
    category: "AULAS",
    videoId: "Zq2p5VHsaaA",
  ...
  {
    id: 10,
    title: "URBAN MOVEMENT // RICK SANTANA",
  ...
  {
    id: 11,
    title: "VIDEO DANCE CONCEPT // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "LQfeBytMQpc",
  ...
  {
    id: 12,
    title: "VISUAL PERFORMANCE // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "w2dCq130TSM",
  ...
  {
    id: 13,
    title: "STREET SOUL // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "X2DE-qYcec4",
  ...
  {
    id: 14,
    title: "CINEMATIC DANCE // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "NzKkaxCbvDI",
  ...
  {
    id: 15,
    title: "EXPRESSION VIDEO // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "XExuUsUJyK0",
  ...
  {
    id: 16,
    title: "HIGH ENERGY PIECE // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "bT2B3OMLGtU",
  ...
  {
    id: 18,
    title: "ART IN MOTION // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "geCIeWEMx2s",
  ...
  {
    id: 19,
    title: "TECHNICAL SHOWCASE // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "3fqQ_UVgTEc",
  ...
  {
    id: 20,
    title: "MOVEMENT STUDY // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "YY-7phHu6tc",
  ...
  {
    id: 21,
    title: "VISUAL CHOREO // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "zIsd_l_oGRk",
  ...
  {
    id: 22,
    title: "ELITE PERFORMANCE // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "Psa5tDMkzAk",
  ...
  {
    id: 28,
    title: "SHORT MOVEMENT // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "k2EYA2w0NY8",
  ...
  {
    id: 29,
    title: "DANCE VIBES // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "58GHJeQZEK0",
  ...
  {
    id: 30,
    title: "STREET EXPRESSION // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "hUwj4nH_UMo",
  ...
  {
    id: 31,
    title: "URBAN SOUL SHORT // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "F0Uydbd-ePU",
  ...
  {
    id: 32,
    title: "MOVEMENT FLOW // RICK SANTANA",
    category: "DANCE VIDEOS",
    videoId: "XjUFsWa1v7k",
    image: "https://img.youtube.com/vi/XjUFsWa1v7k/maxresdefault.jpg",
    date: "2024-03-25",
  ...
  {
    id: 33,
    title: "Rick Santana Dance Reel 2024 / MUV PRO 2025",
    category: "DANCE VIDEOS",
    videoId: "9mwmFa3fcjM",
  ...
  {
    id: 23,
    title: "FREESTYLE SESSION 01 // RICK SANTANA",
    category: "FREESTYLES",
    videoId: "JOwgziviXCs",
  ...
  {
    id: 24,
    title: "IMPROVISATION ART // RICK SANTANA",
    category: "FREESTYLES",
    videoId: "gi16qcx130k",
  ...
  {
    id: 25,
    title: "FREESTYLE CONCEPT // RICK SANTANA",
    category: "FREESTYLES",
    videoId: "7O3-UQUTp60",
  ...
  {
    id: 26,
    title: "RAW MOVEMENT // RICK SANTANA",
    category: "FREESTYLES",
    videoId: "lu8gmaQr3Kg",
  ...
  {
    id: 27,
    title: "DICAS DE MOVIMENTO // RICK SANTANA",
    category: "DICAS",
    videoId: "1xkEcWLkWtE",
...
const Hero = () => {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/20 to-brand-black z-10" />
      <img 
        src="https://i.postimg.cc/JhtB5xnq/Image-(1).png" 
    ...
    <section id="about" className="py-24 bg-brand-gray relative">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center flex-row-reverse">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold tracking-tighter uppercase mb-8">
              Sobr<span className="text-white/10">e</span> Mim
            </h2>
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="order-1 md:order-2 aspect-[4/5] relative"
          >
            ...
            <img 
              ...
              className="relative z-10 w-full h-full object-cover grayscale px-2"
            />
          </motion.div>
        </div>
      </div>
        ...
        <div className="flex flex-col mb-12 gap-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-display font-bold tracking-tighter uppercase">Portfólio</h2>
            ...
            {filteredAndSortedProjects.slice(0, visibleCount).map((project) => (
              ...
              >
                <img 
                  src={project.image} 
                  alt={project.title} 
                  className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-110 group-hover:scale-125 object-center"
                  loading="lazy"
                />
    ...
    <section id="teaching" className="py-24 bg-brand-black relative border-y border-white/5">
       <div className="container mx-auto px-6">
        <div className="max-w-4xl">
          ...
          >
            Aulas <span className="text-white/10">&</span> Ensino
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
    ...
    <footer id="contact" className="py-24 bg-brand-black">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24">
          <div>
            <h2 className="text-5xl md:text-7xl font-display font-bold tracking-tighter uppercase mb-12">Vamos<br/>Criar?</h2>
